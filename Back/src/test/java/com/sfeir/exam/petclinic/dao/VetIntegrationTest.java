...
public class VetIntegrationTest {
	...
	public void testFindAllVets() {
		long count = vetDao.countVets();
		assertTrue(
				"Too expensive to perform a find all test for 'Vet', as there are " + count
	...
	public void testFlush() {
		...
		vetDao.flush();
		assertTrue("Version for 'Vet' failed to increment on flush directive",
	...
	public void testMerge() {
		...
		vetDao.merge(obj);
		vetDao.flush();
		assertTrue("Version for 'Vet' failed to increment on merge and flush directive",
				obj.getVersion() > currentVersion || !modified);
	}
